<template>
  <div class="foot">
    <div class="inner">
      <div class="list clear center" :class="[{identity !==3 ? 'wd':'w25'},{'flexAround':identity===4}]">
        ...
        <div :class="{'active':activeIndex===1}" @click="gotoPage(1)" class="w20" v-if="identity !==4">
        ...
        <div
          ...
          class="w20"
        ></div>
        <div :class="{'active':activeIndex===3}" @click="gotoPage(3)" class="w20" v-if="identity !==4">
    ...
    <div class="circle" @click="gotoPage(2)" v-if="identity !==3 && identity !==4">
