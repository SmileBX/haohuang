          ...
          <div class="list-item" v-for="(item,key) in MasterList" :key="key">
              <div class="select__weui-cells ">
                  ...
                  <div class="ipt flex flexAlignCenter">
                      <div class="flex1">
                          <input type="text" class="weui-input" disabled="true" placeholder="请选择" v-model="item.bindName" @click="showChoice(key)">
                      </div>
...
export default {
  ...
  methods: {
    ...
    subConfirm(index){
      this.MasterList[index] = this.list[this.active].RealName
    }
  }
};
</script>
