  ...
  <div class="page">
    ...
    <div class="memberIndex__section mb10">
      ...
      <div class="section__bd">
        ...
        <!-- 执行的时候 -->
        <ul class="navList li_25 center" v-if="identity==4">
          <li>
            <div class="outside" @click="gotoUrl(0)">
              <div class="icon-img">
                <img src="/static/images/icons/n_1.png" alt style="width:39rpx;height:43rpx">
                <span class="circleNum" v-if="info.notconfirmNum>0">{{info.notconfirmNum}}</span>
              </div>
              <p class="title">待处理</p>
            </div>
          ...
          <li>
            <div class="outside" @click="gotoUrl(1)">
              <div class="icon-img">
                <img src="/static/images/icons/n_2.png" alt style="width:39rpx;height:43rpx">
                <span class="circleNum" v-if="info.notpayNum>0">{{info.notpayNum}}</span>
              </div>
              <p class="title">已处理</p>
            </div>
