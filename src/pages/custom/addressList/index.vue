          ...
          <div class="item">
            ...
            <div class="item__ft flex">
              ...
              <div class="flexItem flex1 text_r">
                <div class="iconText inline-block" @click="editAddress(item.id)">
                  <img src="/static/images/icons/eadit.png" class="icon" alt> 编辑
                </div>
                <div class="iconText inline-block" @click="Delete(item.id,index)">
                  <img src="/static/images/icons/del.png" class="icon" alt>删除
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="ftBtn" style="heigth:100rpx;" @click="addNewSite">
      <div class="inner fixed bm0 border-box pd0">
        <div class="btn btn-active fill radius0">
          <img src="/static/images/icons/add.png" class="addImg" alt>添加新增地址
        </div>
      </div>
    </div>
    <!--遮罩层-->
