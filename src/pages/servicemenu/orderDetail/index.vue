  ...
  <div class="page">
    ...
    <div class="ftBtn ftBtns">
      <div class="inner flex fixed bm0 bg_fff border-box justifyContentEnd">
        ...
        <!--查看进度-->
        <div class="button active" v-if="(detail.OrderStatus==2 || detail.OrderStatus==3 ||detail.OrderStatus==4 || detail.OrderStatus==5 || detail.OrderStatus==6 || detail.OrderStatus==7 || detail.OrderStatus==8 || detail.OrderStatus==9) && detail.MemberId==0" @click="seeSchdule(detail.orderId,detail.OrderStatus)">查看进度</div>
